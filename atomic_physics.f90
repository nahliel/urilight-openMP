...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      open (unit=10,file='~/yoni/AtomicDataBase/ionization_data')
      eof=0
      do while (eof.eq.0)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      filename='~/yoni/AtomicDataBase/gfall.dat'
      zlist=.false.
...
!!    calculate partition functions
      ...
      filename='~/yoni/AtomicDataBase/partfnall'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      filename1='~/yoni/AtomicDataBase/gfall.dat'
      filename2='~/yoni/AtomicDataBase/lowhighlines'
      lentape(1)=564986
